...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.recipient_type'
        db.add_column(u'campaign_campaign', 'recipient_type',
                      self.gf('django.db.models.fields.CharField')(default='email', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.recipient_type'
        db.delete_column(u'campaign_campaign', 'recipient_type')
    ...
    models = {
        u'campaign.campaign': {
            ...
            'recipient_type': ('django.db.models.fields.CharField', [], {'default': "'email'", 'max_length': '16'}),
